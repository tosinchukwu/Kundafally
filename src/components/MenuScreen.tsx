  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      ...
      >
        ...
        <h1 className="font-display -mt-2 text-6xl font-black text-gold md:text-8xl">
          FALL
        </h1>
        ...
        <div className="mt-4 flex items-center justify-center gap-2">
          ...
          <span className="font-data text-sm text-gold">1,000 TOKENS</span>
        </div>
        ...
        <motion.button
          ...
          className="mt-12 rounded-xl bg-primary px-12 py-5 font-display text-xl font-bold text-primary-foreground plate-border glow-gold transition-all"
        >
          BEGIN SESSION
        </motion.button>
